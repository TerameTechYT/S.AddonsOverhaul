...
using S.AddonsOverhaul.Modules.Bundles;
using S.AddonsOverhaul.Modules.HarmonyLib;
using S.AddonsOverhaul.Modules.LiveReload;
using S.AddonsOverhaul.Modules.Plugins;
using S.AddonsOverhaul.Modules.Workshop;
using Steamworks;
using UnityEngine;
...
namespace S.AddonsOverhaul.Core
{
    ...
    internal class LoaderManager : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            GUI.color = new Color(1.0f, 1.0f, 1.0f, 0.175f);
            GUI.Label(new Rect(5.0f, 5.0f, Screen.width, 55.0f), $"S.AddonsOverhaul - {Constants.Version}\nLoaded {PluginLoader.NumLoadedPlugins} plugins");
        }
